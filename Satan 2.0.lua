...
c['Accessory (Handle1Accessory)'].Name="yourecoolguy"
...
local hat = Align(char['DrinkHotChocolate'].Handle,char['Right Arm'],false)
...
local hat = Align(char['WDW_FoamFinger'].Handle,char['Left Arm'],false)
...
local hat = Align(char['Rob Shoulder Plush'].Handle,char['Torso'],false)
